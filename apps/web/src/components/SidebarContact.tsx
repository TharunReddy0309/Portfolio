...
export function SidebarContact({ profile }: SidebarContactProps) {
  // Add your linkedin profile photo as 'linkedin-profile.jpeg' in the apps/web/public folder
  const avatarUrl = '/linkedin-profile.jpeg';
  ...
  return (
    <aside className="sidebar-contact">
      ...
      <div className="sidebar-avatar-wrap">
        <img
          ...
          onError={(e) => {
            ...
            t.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(profile.shortName)}&background=7c5cfc&color=fff&size=128`;
          }}
        />
      </div>
      ...
      <div className="sidebar-identity">
        <p className="sidebar-name">{profile.shortName}</p>
